...
--##! Caelestia
hl.bind("SUPER + A", hl.dsp.exec_cmd("caelestia shell drawers toggle sidebar"), { description = "Toggle sidebar" })
hl.bind(
	"SUPER + Space",
	hl.dsp.exec_cmd("caelestia shell drawers toggle launcher"),
	{ description = "Toggle launcher" }
)
hl.bind("SUPER + N", hl.dsp.exec_cmd("caelestia shell drawers toggle dashboard"), { description = "Toggle dashboard" })
hl.bind("SUPER + J", hl.dsp.exec_cmd("caelestia shell drawers toggle bar"), { description = "Toggle bar" })
hl.bind(
	"CTRL + ALT + Delete",
	hl.dsp.exec_cmd("caelestia shell drawers toggle session"),
	{ description = "Toggle session menu" }
)
hl.bind("SUPER + U", hl.dsp.exec_cmd("caelestia shell drawers toggle utilities"), { description = "Toggle utilities" })
hl.bind("SUPER + SHIFT + O", hl.dsp.exec_cmd("caelestia shell drawers toggle osd"), { description = "Toggle OSD" })
...
hl.bind(
	"SUPER + ALT + R",
	hl.dsp.exec_cmd(hyprScripts .. "/../scripts/videos/record.sh"),
	{ locked = true, description = "Record region" }
)
hl.bind(
	"CTRL + ALT + R",
	hl.dsp.exec_cmd(hyprScripts .. "/../scripts/videos/record.sh --fullscreen"),
	{ locked = true }
)
hl.bind(
	"SUPER + SHIFT + ALT + R",
	hl.dsp.exec_cmd(hyprScripts .. "/../scripts/videos/record.sh --fullscreen --sound"),
...
--# Clipboard history (fuzzel, ya que quickshell overview ya no existe)
hl.bind(
	"SUPER + V",
...
--# App launcher (fuzzel como respaldo si caelestia launcher no atrapa la tecla)
--#!
--##! Window
--# Focusing
...
--##! Media
local mediaNextCommand = "caelestia shell mpris next"
...
hl.bind(
	"SUPER + SHIFT + B",
	hl.dsp.exec_cmd("caelestia shell mpris previous"),
	{ locked = true, description = "Previous track" }
)
hl.bind(
	"SUPER + SHIFT + P",
	hl.dsp.exec_cmd("caelestia shell mpris playPause"),
...
hl.bind("XF86AudioStop", hl.dsp.exec_cmd("caelestia shell mpris stop"), { locked = true, description = "Stop media" })
...
hl.bind("SUPER + Y", hl.dsp.exec_cmd("kitty -e ~/.config/hypr/hyprland/scripts/yazi-launch.sh"))
--# Cursed stuff
